    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.PositiveSmallIntegerField(choices=[(1, 'Выполняет'), (2, 'В процессе'), (3, 'Выполнено'), (4, 'Заархивировано')], default=1, verbose_name='Статус')),
                ('priority', models.PositiveSmallIntegerField(choices=[(1, 'Низкий'), (2, 'Средний'), (3, 'Высокий'), (4, 'Максимальный')], default=2, verbose_name='Приоритет')),
